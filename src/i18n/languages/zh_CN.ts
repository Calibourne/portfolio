...
export const zh_CN: Translation = {
	...
	// 研究页面
	[Key.research]: "研究",
	[Key.researchSubtitle]: "学术论文与研究工作",
	[Key.researchTotal]: "总计",
	[Key.researchPublished]: "已发表",
	[Key.researchInReview]: "审稿中",
	[Key.researchInProgress]: "进行中",
	[Key.researchPreprint]: "预印本",
	[Key.researchFeatured]: "精选论文",
	[Key.researchPDF]: "PDF",
	[Key.researchCode]: "代码",
	[Key.researchDOI]: "DOI",
	[Key.researchArXiv]: "arXiv",
	[Key.researchProject]: "项目主页",
	[Key.researchStatusPublished]: "已发表",
	[Key.researchStatusInReview]: "审稿中",
	[Key.researchStatusInProgress]: "进行中",
	[Key.researchStatusPreprint]: "预印本",
	[Key.researchTags]: "研究领域",
	...
	[Key.projectsShowMore]: "展开更多",
	[Key.projectsShowLess]: "收起",
	[Key.projectsTechChart]: "技术栈概览",
	[Key.projectsClearFilter]: "清除筛选",
	[Key.projectsNoMatch]: "没有匹配所选技术的项目",
	...
	[Key.skillsComputerVision]: "计算机视觉",
	[Key.skillsMachineLearning]: "机器学习",
	[Key.skillsBackendSystems]: "后端系统",
	[Key.skillsCloudInfrastructure]: "云基础设施",
	[Key.skillsDataEngineering]: "数据工程",
	[Key.skillLevel]: "熟练度",
	[Key.skillLevelBeginner]: "初学者",
	[Key.skillLevelIntermediate]: "中级",
	[Key.skillLevelAdvanced]: "高级",
	[Key.skillLevelExpert]: "专家",
	[Key.skillLevelFamiliar]: "了解",
	[Key.skillLevelComfortable]: "熟悉",
	[Key.skillLevelStrong]: "熟练",
	[Key.skillLevelDeep]: "精通",
