...
export const zh_TW: Translation = {
	...
	// 研究頁面
	[Key.research]: "研究",
	[Key.researchSubtitle]: "學術論文與研究工作",
	[Key.researchTotal]: "總計",
	[Key.researchPublished]: "已發表",
	[Key.researchInReview]: "審稿中",
	[Key.researchInProgress]: "進行中",
	[Key.researchPreprint]: "預印本",
	[Key.researchFeatured]: "精選論文",
	[Key.researchPDF]: "PDF",
	[Key.researchCode]: "程式碼",
	[Key.researchDOI]: "DOI",
	[Key.researchArXiv]: "arXiv",
	[Key.researchProject]: "專案主頁",
	[Key.researchStatusPublished]: "已發表",
	[Key.researchStatusInReview]: "審稿中",
	[Key.researchStatusInProgress]: "進行中",
	[Key.researchStatusPreprint]: "預印本",
	[Key.researchTags]: "研究領域",
	...
	[Key.skillsComputerVision]: "電腦視覺",
	[Key.skillsMachineLearning]: "機器學習",
	[Key.skillsBackendSystems]: "後端系統",
	[Key.skillsCloudInfrastructure]: "雲端基礎設施",
	[Key.skillsDataEngineering]: "資料工程",
	[Key.skillLevel]: "熟練度",
