...
export const ja: Translation = {
	...
	// 研究ページ
	[Key.research]: "研究",
	[Key.researchSubtitle]: "論文と研究活動",
	[Key.researchTotal]: "合計",
	[Key.researchPublished]: "発表済み",
	[Key.researchInReview]: "査読中",
	[Key.researchInProgress]: "進行中",
	[Key.researchPreprint]: "プレプリント",
	[Key.researchFeatured]: "注目論文",
	[Key.researchPDF]: "PDF",
	[Key.researchCode]: "コード",
	[Key.researchDOI]: "DOI",
	[Key.researchArXiv]: "arXiv",
	[Key.researchProject]: "プロジェクトページ",
	[Key.researchStatusPublished]: "発表済み",
	[Key.researchStatusInReview]: "査読中",
	[Key.researchStatusInProgress]: "進行中",
	[Key.researchStatusPreprint]: "プレプリント",
	[Key.researchTags]: "研究分野",
	...
	[Key.skillsComputerVision]: "コンピュータビジョン",
	[Key.skillsMachineLearning]: "機械学習",
	[Key.skillsBackendSystems]: "バックエンドシステム",
	[Key.skillsCloudInfrastructure]: "クラウドインフラ",
	[Key.skillsDataEngineering]: "データエンジニアリング",
	[Key.skillLevel]: "熟練度",
	[Key.skillLevelBeginner]: "初心者",
	[Key.skillLevelIntermediate]: "中級者",
	[Key.skillLevelAdvanced]: "上級者",
	[Key.skillLevelExpert]: "専門家",
	[Key.skillLevelFamiliar]: "基礎知識",
	[Key.skillLevelComfortable]: "実用レベル",
	[Key.skillLevelStrong]: "習熟",
	[Key.skillLevelDeep]: "専門",
